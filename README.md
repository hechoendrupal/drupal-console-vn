# drupal-console-vn
DrupalConsole Vietnamese Language / ngôn ngữ tiếng Việt
...
```
$ composer require drupal/console-vn
```
...
- Fork this repository following this link [https://github.com/hechoendrupal/drupal-console-vn#fork-destination-box](https://github.com/hechoendrupal/drupal-console-vn#fork-destination-box)
...
```
$ git remote add upstream git@github.com:hechoendrupal/drupal-console-vn.git
```
